...
> [!NOTE]
>
> **The large AI model module is flashed with the online mode firmware by default at the factory. If the offline mode program has been flashed before studying this chapter, please go to [4. Large AI Model Basic Course -> 4.10 Firmware Download]() to download the firmware again.**
...
2. Open the program file under the path [02 Source Code/01 Large Model Application/Tonybot_AI]() under the same directory of this document.
...
2. Open the program file under the path [02 Source Code/02 Smart Traffic Driving Program/line_follow]() under the same directory of this document.
...
2. Open the program file [7. Arduino Programming Projects\02 Source Code\7.8 Large AI Model Offline Course\7.8.2 Image Transmission\02 Image Transmission Program\image\image.ino]() under the same directory of this document.
...
2. Open the program file [7. Arduino Programming Projects\02 Source Code\7.8 Large AI Model Offline Course\7.8.3 Color Recognition\02 Color Recognition Program\02 Tonybot Color Recognition Program\demo\demo.ino]() under the same directory of this document.
