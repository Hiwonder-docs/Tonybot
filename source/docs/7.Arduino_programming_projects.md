...
### 7.1.1 Arduino IDE Installation and Introduction
...
(2) Search for the "[**FastLED.zip**](../_static/source_code/06/Demo.zip)" file and open it.
...
### 7.2.1 Introduction to Sensor-Related Libraries
...
<td colspan="3" >
(1) HWSensor hws;(Create an ultrasonic object);<br>(2) hws.ultrasoundColor(0,0,255,0,0,255);
</td>
</tr>
</tbody>
</table>
...
<td >Usage Instructions</td>
<td colspan="3" >
(1) HWSensor hws; (Create an ultrasonic object);<br>(2) hws.ultrasoundGetDistance(); (Returns the measured distance, including potential interference)
</td>
</tr>
</tbody>
</table>
...
<tr>
<td >Usage Example</td>
<td colspan="3" >(1) LobotServoController lsc(MySerial);(Creates a servo controller object);<br>(2) lsc.moveServo(16,670,500);(Moves the servo with ID 16 to position 670 over 500 milliseconds.)</td>
</tr>
</tbody>
</table>
...
<tr>
<td >Usage example</td>
<td colspan="3" >LobotServoController lsc(MySerial);(Creates a servo controller object);<br>lsc.runActionGroup(0,1);</td>
</tr>
</tbody>
</table>

### 7.2.2 Breathing Light Project
...
<img class="common_img" src="../_static/media/chapter_6/section_2/02/media/image3.png" style="width:350px;"/>
...
[Breathing Light Program](https://drive.google.com/drive/folders/1T_bhOvFg1MlxZThvS0lU3tNSz2s9TyyQ)
...
###  7.2.3 Distance Ranging & Display Project
...
<img class="common_img" src="../_static/media/chapter_6/section_2/03/media/image2.png" style="width:350px;" />

* **Sensor Introduction**

(1) Glowy Ultrasonic Sensor

<img class="common_img" src="../_static/media/chapter_6/section_2/03/media/image3.png" style="width:350px;"  />
...
[Distance Ranging & Display Program](https://drive.google.com/drive/folders/1T_bhOvFg1MlxZThvS0lU3tNSz2s9TyyQ)
...
### 7.2.4 Distance-Controlled Walking Project
...
<img class="common_img" src="../_static/media/chapter_6/section_2/04/media/image3.png" style="width:350px;" />
...
[Distance-Controlled Walking Program](https://drive.google.com/drive/folders/1T_bhOvFg1MlxZThvS0lU3tNSz2s9TyyQ)
...
<img class="common_img" src="../_static/media/chapter_6/section_2/05/media/image3.png" style="width:350px;" />
...
[Treasure Hunt Program](https://drive.google.com/drive/folders/1T_bhOvFg1MlxZThvS0lU3tNSz2s9TyyQ)
...
### 7.2.6 Low-Altitude Navigation Project
...
<img class="common_img" src="../_static/media/chapter_6/section_2/06/media/image3.png" style="width:350px;"/>
...
[ Low-Altitude Navigation Program](https://drive.google.com/drive/folders/1T_bhOvFg1MlxZThvS0lU3tNSz2s9TyyQ)
...
### 7.2.7 Head-Shaking Obstacle Avoidance Project
...
<img class="common_img" src="../_static/media/chapter_6/section_2/07/media/image3.png" style="width:350px;"/>
...
[Head-Shaking Obstacle Avoidance Program](https://drive.google.com/drive/folders/1T_bhOvFg1MlxZThvS0lU3tNSz2s9TyyQ)
...
### 7.2.8 Fall and Recover Project
...
[Fall and Recover Program](https://drive.google.com/drive/folders/1T_bhOvFg1MlxZThvS0lU3tNSz2s9TyyQ)
...
<img class="common_img" src="../_static/media/chapter_6/section_2/09/media/image3.png" style="width:350px;" />
...
<img class="common_img" src="../_static/media/chapter_6/section_2/09/media/image4.png" style="width:350px;" />

For module installation and wiring, please refer to the section 1 in the same folder.

* **Program Download**

[Smart Fan Program](https://drive.google.com/drive/folders/1T_bhOvFg1MlxZThvS0lU3tNSz2s9TyyQ)
...
<img class="common_img" src="../_static/media/chapter_6/section_2/10/media/image3.png"  style="width:350px;"/>

For module installation and wiring, please refer to the section 1 in the same directory.

* **Program Download**

(1) Locate and open the program file **"03 Touch Control Program/touch_action/touch_action.ino"** in the directory corresponding to this section.
...
### 7.2.11 Temperature and Humidity Detection Project
...
<img class="common_img" src="../_static/media/chapter_6/section_2/11/media/image2.png" style="width:350px;"/>
...
<img class="common_img" src="../_static/media/chapter_6/section_2/11/media/image3.png" style="width:350px;"/>
...
(1) Locate and open the program file **"03 Temperature and Humidity Detection Program/temperature_humidity/temperature_humidity"** in the directory corresponding to this section.
...
### 7.3.1 WonderEcho Introduction & Assembly
...
### 7.3.2 Introduction to Speech-Related Library Files
...
### 7.3.3 Distance Ranging & Announcement Project
...
<img class="common_img"  src="../_static/media/chapter_6/section_3/03/media/image3.png" style="width:350px;"  />
...
<img class="common_img"   src="../_static/media/chapter_6/section_3/03/media/image4.jpeg"  style="width:350px;" />
...
[Distance Ranging & Announcement Program](https://drive.google.com/drive/folders/14-9NCzhF6mmovswqt0oEjGabFUfT1L-j)
...
(4) Click <img class="common_img" src="../_static/media/chapter_6/section_3/03/media/image7.png"  /> to upload the program to the ESP32. Wait for the upload to complete.
...
Finally, follow the steps outlined in "[**Program Download**](#program_download_3_3)" to upload the modified code to the Tonybot.
...
### 7.3.4 Human-Robot Interaction Project
...
<img class="common_img"  src="../_static/media/chapter_6/section_3/04/media/image3.jpeg" style="width:350px;" />
...
[Human-Robot Interaction Program](https://drive.google.com/drive/folders/14-9NCzhF6mmovswqt0oEjGabFUfT1L-j)
...
<img class="common_img" src="../_static/media/chapter_6/section_3/05/media/image3.jpeg" style="width:350px;"/>
...
[Voice Control Program](https://drive.google.com/drive/folders/14-9NCzhF6mmovswqt0oEjGabFUfT1L-j)
...
Other commands are processed similarly. A complete list of supported command words can be found in the "**Commands**" table under [Expected Results](#expected_results_3_5).
...
<img class="common_img" src="../_static/media/chapter_6/section_3/06/media/image3.jpeg" style="width:350px;"/>
...
[Fall Recovery Program](https://drive.google.com/drive/folders/14-9NCzhF6mmovswqt0oEjGabFUfT1L-j)
...
### 7.4.1 Overview and Installation of ESP32S3 Vision Module
...
### 7.4.2 Introduction to the Vision Module Library Files
...
(1) Navigate to the "**6. Arduino Programming Projects /6.4 AI Vision Course**" folder and open any program. In this case, we will use "**6.4.6 Face Recognition**" as an example.
...
<td colspan="3" >Before using this function, make sure to call <strong>HW_ESP32S3CAM::begin</strong>.<br />
This function is not used in the subsequent development, so readers can simply review it for reference.</td>
</tr>
</tbody>
</table>
...
<td >Usage instruction</td>
<td colspan="3" >Before using this function, ensure that <strong>HW_ESP32S3CAM::begin</strong> is called.;<br>
Additionally, before using this function, make sure to call <strong>WireWriteByte</strong> to set the register address for reading.</td>
</tr>
</tbody>
</table>
...
<tr>
<td >Usage instruction</td>
<td >Before using this function, please call HW_ESP32S3CAM::begin first.;<br>Additionally, make sure to call the WireReadDataArray function to read multiple bytes of data from the ESP32-S3-Cam vision module.</td>
</tr>
</tbody>
</table>
...
<tr>
<td >Return value</td>
<td >· <strong>1:</strong> Red color detected<br>
· <strong>2:</strong> Green color detected<br>
· <strong>3:</strong> Blue color detected<br>
· <strong>0:</strong> No color detected</td>
</tr>
<tr>
<td >Usage instruction</td>
<td ><strong>Important Notes:<br></strong>Before using this function, please call HW_ESP32S3CAM::begin.;<br>Before using this function, make sure to call the WireReadDataArray function to read multiple bytes of data from the ESP32-S3-Cam vision module.
</td>
</tr>
</tbody>
</table>
...
<tr>
<td >Usage instruction</td>
<td colspan="3" >Before using this function, please call HW_ESP32S3CAM::begin.<br />
Also, ensure that the WireReadDataArray function is called to read multiple bytes of data from the ESP32-S3-Cam vision module.</td>
</tr>
</tbody>
</table>
...
[ESP32S3 Color Recognition Example](../_static/source_code/06/ESP32S3%20Color%20Recognition%20Example.zip)

① Connect the ESP32-S3 vision module to your computer using a Type-C data cable.

② Extract the ZIP file "[**Image Transmission Firmware & Flash Tool/flash_download_tool_3.9.7**](https://docs.hiwonder.com/projects/Tonybot/en/latest/docs/resources_download.html)" located in the same folder, then double-click **"flash_download_tool_3.9.7.exe"** to open the program.
...
[Image Transmission Arduino Example](https://drive.google.com/drive/folders/1cMRv7eNY678YAZ60CvvvWXu_DnF5f5Ye)
...
(1) Power on the device (ensure the vision module is installed on the robot as described in "**[6.4.1 Overview and Installation of ESP32S3 Vision Module](#anchor_6_4_1)**" before powering it on).
...
### 7.4.4 Color Recognition Project
...
<img class="common_img" src="../_static/media/chapter_6/section_4/04/media/image3.png"  style="width:350px;" />
...
<img class="common_img" src="../_static/media/chapter_6/section_4/04/media/image4.png"  style="width:350px;" />
...
<img class="common_img" src="../_static/media/chapter_6/section_4/05/media/image3.png" style="width:350px;" />

The ESP32-S3 Vision Module is a compact camera module that can function as a standalone system. It captures images with its built-in camera, processes the data using the ESP32 microcontroller, and wirelessly transmits it via Wi-Fi. With support for various communication protocols and low-power features, this module is widely used in a range of IoT applications.

To get the detailed installation guide, please refer to "**[6.4.1 Overview and Installation of ESP32S3 Vision Module](#anchor_6_4_1)**".
...
### 7.4.6 Face Recognition Project
...
<img class="common_img" src="../_static/media/chapter_6/section_4/06/media/image3.png" style="width:350px;"/>
...
[ ESP32S3 Face Detection Example](../_static/source_code/06/ESP32S3%20Face%20Detection%20Example.zip)
...
[Face Recognition Arduino Example](https://drive.google.com/drive/folders/1cMRv7eNY678YAZ60CvvvWXu_DnF5f5Ye)
...
### 7.4.7 Vision Line Following Project
...
<img class="common_img" src="../_static/media/chapter_6/section_4/07/media/image3.png" style="width:350px;"/>
...
[Vision Line Following Arduino Example](https://drive.google.com/drive/folders/1cMRv7eNY678YAZ60CvvvWXu_DnF5f5Ye)
...
The color to be tracked is defined as "**0x00**" (red) in the `hw_esp32cam_ctl.cpp` file. To track a different color, refer to "**6.4.2 Introduction to the Vision Module Library Files and Registers /Register Description**" to modify the corresponding register address.
...
[Tonybot IOT Example](https://drive.google.com/drive/folders/1XKT8_9jB7PwrYw6ta1DGIbBNeMhE7Mk5)

### 7.5.1 Module Installation & Wiring
...
<img class="common_img" src="../_static/media/chapter_4/section_5/03/media/image4.jpeg"  style="width:350px;" />

(3) Once connected, the Wi-Fi icon in the top-right corner will become solid.

<img class="common_img" src="../_static/media/chapter_4/section_5/03/media/image5.jpeg" style="width:350px;"  />
...
### 7.5.4 Face Detection Alert Project
...
<img class="common_img" src="../_static/media/chapter_6/section_5/04/media/image3.png" style="width:350px;"  />
...
For instructions on downloading the vision module and Tonybot program, please refer to the "**[6.5.2 Program Download](#anchor_6_5_2)**" section.
...
<img class="common_img" src="../_static/media/chapter_6/section_5/05/media/image3.png" style="width:350px;"  />
...
<img class="common_img" src="../_static/media/chapter_6/section_5/07/media/image3.png" style="width:350px;" />
...
<img class="common_img" src="../_static/media/chapter_6/section_5/08/media/image3.png" style="width:350px;"/>
...
<img class="common_img" src="../_static/media/chapter_6/section_5/09/media/image3.png" style="width:350px;"/>
...
```
  ...
  if(compare_data(&read_data[0][4] , &read_data[1][4] , 15) != 0)  
  {
...
```
    ...
    if(data.startsWith("CMD") && data.endsWith("$")) 
    {
      data = data.substring(data.indexOf('|') + 1,data.indexOf('$'));
      while(data.indexOf("|") != -1){
        rec_data[index] = data.substring(0, data.indexOf('|')).toInt();  
...
### 7.6.1 Master-Slave Communication Principles
...
### **7.7.1 AI Module Mode Description**

The large AI model module supports **two working modes**, which are **offline mode** and **online mode**. Since these two modes have different functions, **the corresponding firmware must be flashed**. **The online mode is used in this chapter**.


> [!NOTE]
>
> **The large AI model module is flashed with the online mode firmware by default at the factory. If the offline mode program has been flashed before studying this chapter, please go to [4. Large AI Model Basic Course -> 4.10 Firmware Download](https://docs.hiwonder.com/projects/Tonybot/en/latest/docs/4.%20Large%20AI%20Model%20Basic%20Course.html#firmware-download) to download the firmware again.**

#### 7.7.1.1 Offline Mode

In offline mode, the module collects images through the built-in camera module and processes the image data using the ESP32-S3 main control chip. This enables functions such as image transmission, color recognition, face recognition, and vision-based line following, with data transmittable via various communication protocols.

To learn more about offline mode applications, please refer to [7.8 Large AI Model Offline Course](https://docs.hiwonder.com/projects/Tonybot/en/latest/docs/7.Arduino_programming_projects.html#large-ai-model-offline-course).

#### 7.7.1.2 Online Mode

Online mode supports large AI model voice interaction. It uses command wake-up mode, requiring the wake-up phrase to be spoken to wake up the large AI model module before human-robot interaction can begin. The default wake-up phrase is **Hello Hiwonder**. To change the wake-up phrase, please go to [4. Large AI Model Basic Course -> 4.9 Wake-up Word Modification](https://docs.hiwonder.com/projects/Tonybot/en/latest/docs/4.%20Large%20AI%20Model%20Basic%20Course.html#wake-up-word-modification).

After the module recognizes the wake-up phrase, the buzzer will beep once, and then the interaction can begin. The module supports voice communication, automatically recognizing and adapting to the spoken language. If no voice is recognized within one minute, the module will enter sleep mode, requiring a wake-up again before the next use.

### **7.7.2 Voice Control**

> [!NOTE]
>
> **Before learning this section, ensure that the module is turned on and Wi-Fi and Agent configurations are completed according to [4. Large AI Model Basic Course -> 4.2 Network Configuration and Device Binding](https://docs.hiwonder.com/projects/Tonybot/en/latest/docs/4.%20Large%20AI%20Model%20Basic%20Course.html#network-configuration-and-device-binding).**

#### 7.7.2.1 Project Introduction

This section controls the robot through WonderLLM online voice interaction. The program analysis here refers to the **Tonybot_AI** Arduino project in the repository. The entire program integrates voice command parsing, action execution, running mode switching, ultrasonic status query, and pose status query into a single workflow.

The program registers five categories of capabilities with WonderLLM which are buzzer control, RGB light control, action group execution, running mode switching, and robot status query.

#### 7.7.2.2 Implementation Process

<img src="../_static/media/chapter_9/section_3/media/image1_en.png" class="common_img" style="width:1000px" />

#### 7.7.2.3 Module Description

The large AI model module has a built-in ESP32-S3 high-performance chip. It integrates a 2-megapixel high-definition camera, a microphone, a high-definition display, a speaker, and a CI1302 voice processing chip, deeply merging multiple models including text, voice, and vision.
...
#### 7.7.2.4 Program Download

1. Connect the Type-C port of the Tonybot ESP32 controller to the computer using a Type-C data cable.

<img class="common_img" src="../_static/media/chapter_6_7/section_1/media/image20.png" style="width:400px"/>

2. Open the program file under the path [02 Source Code/01 Large Model Application/Tonybot_AI](https://drive.google.com/drive/folders/1FRK31KEwpJ6vDfls5K8zPC7Uh_doqirc?usp=sharing) under the same directory of this document.

3. Select the development board model as **ESP32 Dev Module** and select the corresponding port.

<img src="../_static/media/chapter_6_8/section_1/media/image30.png"     class="common_img"/>

4. Click **Tools** in the menu bar and select the corresponding ESP32-S3 development board configuration as shown in the figure below. This configuration is required for the first use and is not needed for subsequent uses.

<img src="../_static/media/chapter_6_8/section_1/media/image31.png"     class="common_img"/>

5. Click <img src="../_static/media/chapter_6_8/section_1/media/image17.png"     class="common_img" style="width:45px"/> to download the program into the Tonybot large AI model module and wait for the flashing to complete.

<img src="../_static/media/chapter_6_8/section_1/media/image32.png"     class="common_img" style="width:600px"/>

6. Wait for a moment, and a message indicating a successful upload will pop up in the message window below.

<img src="../_static/media/chapter_6_8/section_1/media/image19.png"     class="common_img" style="width:600px"/>


#### 7.7.2.5 Program Outcome

After waking up the large AI model module, the following commands can be directly issued via voice:

| Number | Capability             | Corresponding Tool      | Description                                                  |
| ------ | ---------------------- | ----------------------- | ------------------------------------------------------------ |
| 1      | Buzzer control         | `set_buzzer`            | Set the beep count `count` and frequency `freq` from 100 to 5000. |
| 2      | RGB light control      | `set_led_color`         | Set the RGB values from 0 to 255 for the left and right lights respectively. |
| 3      | Action group execution | `set_action_group`      | Specify the action group number `actionNum` and execution count `executeNum`. |
...
Refer to the following voice examples:
...
#### 7.7.2.6 Program Analysis

1. The main program **Tonybot_AI.ino** and the communication files **WonderLLM.cpp** and **WonderLLM.h** together constitute the complete voice control workflow. The former is responsible for robot actions and sensor logic, while the latter handles I2C communication with WonderLLM.
...
2. Three running modes and action group numbers for obstacle avoidance, moving forward, moving backward, turning left and right, and standing up quickly are defined at the beginning of the program. These constants are repeatedly used in subsequent voice control and automatic modes.
...
3. In `setup()`, the serial port, servo, buzzer, action controller, WonderLLM module, and IMU are initialized sequentially. After initialization is complete, the robot returns to the default standing pose first, and then enters the normal workflow.
...
4. A total of five MCP tools are registered in **WonderLLM.cpp** which are `set_buzzer`, `set_led_color`, `set_action_group`, `set_mode`, and `self.robot.get_status`. The capabilities that the large model can call later depend on the tools registered here.
...
const char tool_mode[] =
    "{\"tool_name\":\"set_mode\",\"command\":\"Call this tool when switching robot modes. Mode options: \'avoid\', \'follow\', \'normal\'\","
    "\"params\":[[\"running_mode\",\"string\"]],\"block\":\"true\","
    "\"return\":\"false\"}";
```

5. `register_tools()` sends these tool definitions sequentially after the module goes online, and finally sends the `mcp_setting` end command to notify WonderLLM that tool registration is complete.
...
6. `WonderLLM_Init()` initializes I2C first, and then repeatedly detects the WonderLLM module at the address `0x55`. After successful detection, the I2C speed is increased to `400000`. Once the tool registration is completed, the speed is switched back to the normal communication rate.
...
7. `WonderLLM_Info_Get()` is the data receiving entry point repeatedly called in the main loop. It is responsible for detecting the online status of the module, receiving a complete frame of data, and saving the raw JSON into `json_data_raw`.
...
8. When receiving packets at the underlying layer, the program reads the 8-byte frame header first, and then verifies the `0xAA 0x55` header mark, packet ID, data length, and checksum. This prevents incomplete or incorrect data from being treated as valid commands.
...
9. `parse_command()` determines the command type based on the key fields in the JSON. For example, containing `status_name` represents a status query, containing `lr` represents an RGB command, containing `count` represents a buzzer command, and containing `running_mode` represents a mode switch.
...
10. Mode switching is compatible with both string and numeric formats. For instance, when `avoid`, `follow`, or `normal` appears in the command, the program automatically converts them into internal mode numbers.
...
11. The main loop `loop()` updates the battery voltage, IMU, and WonderLLM data first, and then dispatches and executes specific actions according to `Frame_mode`. Lights, buzzer, action groups, mode switching, and status queries are all handled here in a unified manner.
...
12. Blocking tools must call `WonderLLM_Send_Action_Finish()` to reply to the module after execution is completed, while status queries return data through `WonderLLM_Send_Status()`. In other words, execution type commands return a completion signal, whereas query type commands return status values.
...
#### 7.7.2.7 Function Extension

* #### What is MCP

MCP, which stands for Model Context Protocol, is an open protocol that enables calls between LLMs and external tools. This allows the large model to do more than just chat, enabling it to read external states, call hardware functions, and drive robots to execute actions.

* #### How to Define MCP

1. Each MCP tool is registered as a **JSON** string. Five tools are registered in the current reference project, which are `set_buzzer`, `set_led_color`, `set_action_group`, `set_mode`, and `self.robot.get_status`.
...
2. `tool_name` is the name of the tool. The naming should be as clear as possible to help the large model determine which tool to call based on the context.

```c
"tool_name":"set_buzzer"
```

3. `command` is used to describe when to call this tool and what each parameter represents. The clearer this description is, the more stable the parameters generated by the large model will be.
...
4. `params` is used to define the parameter format, and a common syntax is **[[\"parameter_name\",\"parameter_type\",minimum_value,maximum_value]]**. If the parameter type is `string`, the range of values is usually not required.

```c
"params":[["count","int"],["freq","int",100,5000]]
```

5. `block` indicates whether the current tool is executed blockingly. If it is `true`, the robot also needs to send back `action_finish` after executing the action.
...
6. `return` indicates whether the current tool needs to return specific data. Query type tools are usually `true`, while execution type tools are usually `false`.

```c
const char tool_status[] =
    "{\"tool_name\":\"self.robot.get_status\",\"command\":\"Call this tool when querying real-time robot status. Can query \'battery\' (unit mV), \'distance\' (unit mm), \'running_mode\', \'Bodystate\' (1 for falling forward, 0 for standing, 2 for falling backward)\",\"params\":[[\"status_name\",\"string\"]],\"block\":\"true\",\"return\":\"true\"}";
...
7. For example, the mode switching tool in the current program only receives a single `running_mode` string parameter, so the large model can directly issue three mode values: `avoid`, `follow`, and `normal`.
...
8. To extend new capabilities, it is only necessary to add new tool definitions, complete the registration in `register_tools()`, and add the corresponding execution logic in `parse_command()` and the main loop.
...
### **7.7.3 Singing and Dancing**

#### 7.7.3.1 Project Introduction

When saying **play music and dance** to the large AI model module, the module will randomly broadcast a piece of music and call the `set_action_group` tool to make Tonybot execute the dancing action group.

#### 7.7.3.2 Implementation Process

<img src="../_static/media/chapter_9/section_5/media/image1_en.png" class="common_img" style="width:1000px" />

#### 7.7.3.3 Module Description

The large AI model module has a built-in ESP32-S3 high-performance chip. It integrates a 2-megapixel high-definition camera, a microphone, a high-definition display, a speaker, and a CI1302 voice processing chip, deeply merging multiple models including text, voice, and vision.

<img src="../_static/media/chapter_9/section_1/media/image120.png"     class="common_img" style="width:400px"/>

#### 7.7.3.4 Program Download
...
#### 7.7.3.5 Program Outcome

After entering the voice dialogue, Tonybot can be directly commanded to execute action groups. Common examples are as follows:

| Command     | Description                  | Typical Action Group |
| ----------- | ---------------------------- | -------------------- |
| Say hello   | Executes the waving action.  | `9`                  |
| Do push-ups | Executes the push-up action. | `7`                  |
| Do sit-ups  | Executes the sit-up action.  | `8`                  |
| Dance       | Executes the dancing action. | `150~158`            |

#### 7.7.3.6 Program Analysis

1. The entry point for action group control is `tool_action_group`. Two parameters, `actionNum` and `executeNum`, are defined here, representing the action group number and execution count respectively.
...
2. The common action numbers and meanings are directly written into the `command` field for the large model. This makes it easier for the large model to generate the correct action group number when commands such as waving or dancing are spoken.
...
3. When the received JSON contains the `actionNum` field, `parse_command()` identifies it as `Frame_ActionGroup` and extracts the action group number and execution count.
...
4. After receiving `Frame_ActionGroup` in the main loop, `action_finish` is sent back first, and then the action controller is called to execute the corresponding action group.
...
### **7.7.4 Smart Obstacle Avoidance**

#### 7.7.4.1 Project Introduction

This section corresponds to the intelligent obstacle avoidance function of the robot. The obstacle avoidance mode can be switched to `avoid` directly by calling `set_mode` through WonderLLM. After entering this mode, the robot will judge whether to continue moving forward, turn left, turn right, or move backward based on the ultrasonic distance measurement and head scanning results.

#### 7.7.4.2 Implementation Process

<img src="../_static/media/chapter_9/section_6/media/image1_en.png" class="common_img" style="width:1000px" />

#### 7.7.4.3 Module Description

The large AI model module has a built-in ESP32-S3 high-performance chip. It integrates a 2-megapixel high-definition camera, a microphone, a high-definition display, a speaker, and a CI1302 voice processing chip, deeply merging multiple models including text, voice, and vision.

<img src="../_static/media/chapter_9/section_1/media/image120.png"     class="common_img" style="width:400px"/>

#### 7.7.4.4 Program Download

1. Connect the Type-C port of the Tonybot ESP32 controller to the computer using a Type-C data cable.

   <img class="common_img" src="../_static/media/chapter_6_7/section_1/media/image20.png" style="width:400px"/>

2. Open the program file under the path [02 Source Code/01 Large Model Application/Tonybot_AI](https://drive.google.com/drive/folders/1FRK31KEwpJ6vDfls5K8zPC7Uh_doqirc?usp=sharing) under the same directory as this document.
...
#### 7.7.4.5 Program Outcome

Typical effects are as follows:

| Command or Status                       | Effect                                                       |
| --------------------------------------- | ------------------------------------------------------------ |
| Switch to obstacle avoidance mode       | The robot enters `avoid` mode and starts automatic distance measurement and obstacle avoidance |
| No obstacle in front                    | The robot continues to walk forward                          |
| Front is blocked but one side has space | The robot automatically selects to turn left or right        |
| Neither side is suitable for passage    | The robot moves backward and replans                         |
| Switch to normal mode                   | The robot exits obstacle avoidance and returns to the normal control status |

#### 7.7.4.6 Program Analysis

1. In the program, three constants: `MODE_NORMAL = 0`, `MODE_AVOID = 1`, and `MODE_FOLLOW = 2` are used to represent the running modes. `current_running_mode` records the current target mode, and `active_running_mode` records the actual mode currently being executed.
...
2. When the large model switches modes, it sends the `running_mode` to the control board through `tool_mode` first. After recognition by `parse_command()`, `avoid`, `follow`, and `normal` are converted into internal numbers.
...
3. `setRunningMode()` handles mode switching while clearing the step variables used in the obstacle avoidance and follow workflows to prevent carrying over the intermediate state from the previous run after switching modes.
...
4. `processRunningMode()` detects whether the mode has changed. If a change is detected, it executes exiting the old mode first, and then entering the new mode. Subsequently, it determines whether to run the obstacle avoidance logic based on the current mode.
...
5. `obstacleAvoidance()` is the core function for obstacle avoidance, which is internally divided into multiple stages via `obstacle_step`. Step `0` checks whether the robot can continue moving forward directly ahead. Step `1` continuously monitors during the forward movement. Step `2` starts scanning the environment. Step `3` selects turning or moving backward based on the left and right distances.
...
6. `getAllDistance()` controls the head servo to rotate to positions including the center, front-left, far-left, front-right, and far-right sequentially for distance measurement, finally obtaining three sets of data: `gDistance`, `gLDistance`, and `gRDistance` for subsequent turning decision-making.
...
7. After the scan is complete, if the left space is larger, the robot turns left, and if the right space is larger, it turns right. If neither side is suitable, it moves backward for a distance before making a judgment again. `last_action_is_go_back` is used to record whether the backward action was just executed in the previous round.
...
#### 7.7.5.1 Project Introduction

This section corresponds to the pose detection and fall recovery of Tonybot. The program continuously reads IMU pose data and sends back to the large AI model module whether the robot is currently standing, falling forward, or falling backward. When recovery is needed, the stand-up action is executed through action groups.

#### 7.7.5.2 Implementation Process

<img src="../_static/media/chapter_9/section_7/media/image1_en.png" class="common_img" style="width:1000px" />

#### 7.7.5.3 Module Description
...
#### 7.7.5.5 Program Outcome

The following workflow can be realized in this example:

1. Query `Bodystate` to identify whether the robot is currently standing, falling forward, or falling backward.
2. Issue the action group recovery command based on the pose result, such as `101` for standing up from falling backward and `102` for standing up from falling forward.
3. After the recovery action is executed, the robot returns to the state where interaction can continue.

#### 7.7.5.6 Program Analysis

1. Pose detection related variables are defined at the beginning of the main program, including the current pose `body_state`, forward fall and backward fall counters, and IMU calibration related parameters.
...
2. After powering on, the robot does not directly use the first frame of IMU data as the reference value. Instead, it calls `startImuPoseCalibration()` first, and then `serviceImuPoseCalibration()` continuously collects multiple sets of pose data to calculate the reference roll angle when standing.
...
3. `serviceImuPoseCalibration()` samples IMU data at intervals. Only after obtaining sufficiently stable samples is the average value written into `imu_roll_reference`, which avoids pose reference instability when just powering on.
...
4. `updateBodyState()` continuously reads the current roll angle and calculates the difference from the reference value. When the difference is less than `-30` degrees and appears consecutively multiple times, it is determined as falling forward. When the difference is greater than `30` degrees and appears consecutively multiple times, it is determined as falling backward. Other cases are regarded as standing normally.
...
5. `Bodystate` is already exposed to the large model in `tool_status`, allowing the current pose to be directly queried via voice.
...
6. When WonderLLM queries `Bodystate`, the main loop calls `sendStatusBodyState()` to send back the current pose value to the module according to the protocol.
...
### **7.7.6 Obstacle Detection**

#### 7.7.6.1 Project Introduction

This section corresponds to the ultrasonic distance measurement query capability of Tonybot. After a status query is initiated via voice, the program reads the current distance and sends it back to the large AI model module for broadcasting or subsequent judgment. This function can both answer how far the obstacle is in front individually and be used continuously in obstacle avoidance mode.

#### 7.7.6.2 Implementation Process

<img src="../_static/media/chapter_9/section_8/media/image1_en.png" class="common_img" style="width:1000px" />

#### 7.7.6.3 Module Description
...
#### 7.7.6.5 Program Outcome

Typical effects are as follows:

| Function           | Description                                                  | Return Value Example                          |
| ------------------ | ------------------------------------------------------------ | --------------------------------------------- |
| Distance detection | Reads ultrasonic distance measurement and returns millimeter values | `distance = 235`                              |
| Linked prompt      | Can be combined with the large model to generate voice broadcasting or action suggestions | "There is an obstacle about 23.5 Cm in front" |

#### 7.7.6.6 Program Analysis

1. The ultrasonic object is directly instantiated at the beginning of the program, and the distance reading function `sonarGetDistanceMm()` returns the currently measured millimeter value.
...
2. No additional new tool is defined for distance query. Instead, the unified status query tool `self.robot.get_status` is reused. This allows battery level, distance, mode, and pose to be accessed from the same interface.
...
3. When the voice command contains `status_name` and further matches `distance`, `parse_command()` identifies the command as `Frame_get_status_distance`.
...
4. After receiving `Frame_get_status_distance` in the main loop, it calls `sendStatusDistance()` to read the current distance measurement and send it back through `WonderLLM_Send_Status()`.
...
5. In `loop()`, similar to other status queries, the distance query belongs to the return data type. Therefore, `action_finish` is not sent, and the status value is returned directly.
...
### **7.7.7 Smart Traffic Driving**

#### 7.7.7.1 Project Introduction

This section mainly uses the ESP32-S3 vision module together with the Tonybot robot to perform line following driving, and realizes traffic light recognition through the large AI model module to control the robot to stop or proceed.

#### 7.7.7.2 Implementation Process

<img src="../_static/media/chapter_6_7/section_1/media/image18_en.png" class="common_img" style="width:1000px" />

#### 7.7.7.3 Module Description
...
The ESP32-S3 vision module is a highly cost-effective AI vision solution. Developed based on the ESP32-S3 high-performance chip, it supports Wi-Fi video streaming, color recognition, face recognition, and line following recognition. Integrating a 2-megapixel camera and manufactured with industrial-grade processes, the module is programmed in C or C++. It is equipped with a Type-C serial port, an I2C interface, and customized buttons, providing convenient hardware interaction interfaces.

<img src="../_static/media/chapter_6_7/section_1/media/image19.png"     class="common_img" style="width:600px"/>

#### 7.7.7.4 Program Download

1. Connect the Type-C port of the Tonybot ESP32 controller to the computer using a Type-C data cable.

<img class="common_img" src="../_static/media/chapter_6_7/section_1/media/image20.png" style="width:400px"/>

2. Open the program file under the path [02 Source Code/02 Smart Traffic Driving Program/line_follow](https://drive.google.com/drive/folders/1FRK31KEwpJ6vDfls5K8zPC7Uh_doqirc?usp=sharing) under the same directory as this document.
...
#### 7.7.7.5 Program Outcome

After the program is powered on, it initializes the robot and I2C peripherals and waits for the large AI model module at 0x55 to be ready. Subsequently, it enters the line following mode, continuously reading the line position from the camera to control the robot to move straight or turn for line following and moving forward. When the yellow line trigger point is recognized and the blue block condition is satisfied, it switches to the waiting stage and cyclically issues camera vision requests to the large AI model module while polling for returned results. When the recognition result is a green light indicating vision is true, it executes the passing action group, returns to the initial pose after completion, and re-enters the line following. The entire process runs in a loop.

#### 7.7.7.6 Program Analysis

1. The entry point of the program is in **line_follow.ino**. It imports the underlying configuration, serial port/action group control, sensor, camera, and WonderLLM communication libraries first to prepare for subsequent state machine and peripheral calls.

```cpp
#include "base_config.h"
#include "HardwareSerial.h" // Serial port library
#include "LobotServoController.h" // Servo controller library
#include "Arduino.h"
#include "HWSensor.h" // Sensor library
#include "Hiwonder.hpp"
#include "hw_esp32cam_ctl.h" // Import ESP32Cam communication library
#include "tonybot_camera.h" // Import ESP32Cam communication library
#include "WonderLLM.h"
```

2. Global objects and key constants are defined at the top of the file. `Controller` which is initialized as `Controller(Serial2)` is responsible for sending action groups to the chassis. `s3_camera` handles local color block recognition. `stage` and the `tickstart` variables constitute the three-stage state machine and the two-channel timers.

```cpp
#define TURN_RIGHT  66     /* Right turn action group 24 35 4 */
#define TURN_LEFT   65     /* Left turn action group 23 34 3 */
#define GO_STRAIGHT 63     /* Straight walk action 21 */
#define RETREAT     22     /* Move backward action */
#define TRANSITION  18     /* Transition action leaning right */

LobotServoController Controller(Serial2); // Instantiate secondary development communication library
HWSensor hwsensor;  // Instantiate sensor class
...
const uint16_t LEFT_MIN = 240 / 2 - 40;    // Left threshold value
const uint16_t RIGHT_MAX = 240 / 2 + 40;   // Right threshold value

uint32_t tickstart1 = 0;
uint32_t tickstart2 = 0;

static char info[128];
const char vison_prompt[] = "Identify the front image. If there is a traffic light in front and it is green, return only true. Otherwise, return only false. Do not return any other information.";

Stage_t stage = STAGE_LINETRACKING;
```

3. `setup()` completes three types of initialization. These are the camera I2C begin, the start of the debugging serial port, and the chassis serial port `Serial2`. Subsequently, it initializes WonderLLM and executes the standing action group once as the initial pose, finally printing start. to indicate entry into the main loop.
...
void setup() {
  ...
  s3_camera.begin();
  Serial.begin(115200);
  // Initialize the serial port communicating with the chassis
  Serial2.begin(9600 , SERIAL_8N1 , IO_BaseRX , IO_BaseTX);
  delay(200); // Wait for chassis initialization to complete
...
4. `loop()` uses `stage` to implement the three-stage state machine. The line following stage relies on the local camera to detect red blocks and call `body_follow`. When a blue block is detected and its threshold meets the requirement, it switches to the WAITING stage, and initializes two-channel timestamps for the subsequent sequence of 1 second request and 50 milliseconds polling.
...
5. The core of the WAITING stage is triggering a vision request and reading the return at high frequency. Every 1 second, it calls `WonderLLM_Request_Vision(vison_prompt)` to let WonderLLM capture images and perform inference. Every 50 milliseconds, it calls `WonderLLM_Info_Get()` to read the I2C results. If the raw JSON string contains `true`, it is judged as a green light and triggers the action group.
...
6. The CUSTOM stage is used to execute the end or reset action and return to line following. In this project, it executes the standing action, which is action group 0, and sets `stage` back to `STAGE_LINETRACKING`. Thus, the entire process repeats in a cycle, which is line following, waiting for the light, passing, and then line following again.
...
7. `body_follow(x)` is the line following control. It selects the go straight, turn left, or turn right action group based on the relationship between the horizontal position of the red block `x` and the thresholds `LEFT_MIN` and `RIGHT_MAX`. It also uses `step` to perform a simple two-stage correction, turning wide first and then turning tight when leaning left or right.
...
void body_follow(uint8_t x)
{
  ...
  {
    case 0:
      // In the middle, go straight
      if(x > LEFT_MIN && x < RIGHT_MAX)
      {
        Controller.runActionGroup(GO_STRAIGHT, 1);
        delay(850);
      }else if(0 < x && x < LEFT_MIN){ // Leaning left, turn left
        Controller.runActionGroup(TURN_LEFT, 2);
        delay(2700);
        step = 1;
      }else{ // Leaning right
        Controller.runActionGroup(TURN_RIGHT, 2);  // Turn to the right
        delay(2850);
        step = 2;
      }
      break;
    case 1: // Leaning left
      if(0 < x && x < LEFT_MIN) // Unadjusted
      {
        Controller.runActionGroup(TURN_LEFT, 1);
        delay(1350);
      }else{
      ...
      break;
    case 2: // Leaning right
      if(x > RIGHT_MAX)
      {
        Controller.runActionGroup(TURN_RIGHT, 1);  // Turn to the right
        delay(1450);
      }else{
        Controller.runActionGroup(GO_STRAIGHT, 1);
        delay(900);
...
8. Local camera color block detection is encapsulated by `HW_ESP32S3Cam`. Specifically, `red_block_detection` and `blue_block_detection` actually read different registers, which are `0x00` and `0x02`, at the I2C address `0x52`, and write the recognition results into `read_val` for use by `loop()` judgment and line following control.
...
9. `HW_ESP32S3Cam::red_block_detection` and `blue_block_detection` directly call `wire_read_array` to read the array from the corresponding registers. Therefore, the threshold judgments on `read_val[0]`, which is position, and `read_val[1]`, which represents intensity and area, in **line_follow.ino** ultimately originate from the data read back via I2C.
...
10. The I2C address and data structure of WonderLLM are defined in **WonderLLM.h**. This includes `WONDERLLM_SLAVE_ADDRESS=0x55` and the use of the `json_data_raw` buffer in `WonderLLM_Info` to receive the raw JSON returned from the module, with `Frame_mode` marking the parsed message type.
...
typedef struct{
    ...
    char json_data_raw[256];                /* Buffer for storing raw MCP commands */
}WonderLLM_Info;
```

11. WonderLLM initialization `WonderLLM_Init()` configures the I2C pins and buffer first, and then detects whether the secondary device exists in a loop. Once detected, it increases the I2C speed to 400kHz and calls `register_tools()` to complete the MCP tool registration, finally switching the I2C speed back to 100kHz to maintain compatibility with other low-speed devices.
...
bool WonderLLM_Init(void) {
    ...
    while (1) {
        // 1. Check whether device is ready
      ...
      return true;
         }else{   // 2. If device is not found, check whether timeout has occurred
...
12. The camera call itself resides in `WonderLLM_Request_Vision(prompt)`. The MCU packages the `prompt` into the JSON string `{"tool_name":"mcu.request","command":"vision","params":"..."}` and transmits it to WonderLLM over I2C. This is an RPC pattern requesting a single vision recognition, and the project repeatedly triggers this request every 1 second during the WAITING stage.
...
13. Result reading is performed in `WonderLLM_Info_Get()`. After receiving a complete fragmented frame from I2C, it writes the raw JSON into `json_data_raw` and appends `\0` to form a C string, subsequently calling `parse_command()` to identify the message type. In this project, **line_follow.ino** mainly utilizes `json_data_raw` to check for the `true` string.
...
void WonderLLM_Info_Get(WonderLLM_Info *obj) {
  ...
  if (Detect_WonderLLM() == true) {
    ...
    // Copy the raw JSON string sent by WonderLLM to json_data_raw for backup
    if (receive_frame((uint8_t*)obj->json_data_raw, &received_len)) {
      if (received_len > 0) {
...
14. The underlying mechanism of action group control is handled in `LobotServoController::runActionGroup()`. It transmits the `0x55 0x55` header, the `CMD_ACTION_GROUP_RUN` command, which is `0x06`, the action number, and the execution count over the chassis serial port. Therefore, commands including moving straight, turning, and standing in **line_follow.ino** are mapped to different action group numbers for execution.

```cpp
void LobotServoController::runActionGroup(uint8_t numOfAction, uint16_t Times)
{
  uint8_t buf[7];
  buf[0] = FRAME_HEADER;   // Fill in header
  buf[1] = FRAME_HEADER;
  buf[2] = 5;      // Data length, the number of bytes in the data frame excluding the header, this command is fixed at 5
  buf[3] = CMD_ACTION_GROUP_RUN; // Fill in command for running action group
  buf[4] = numOfAction;      // Fill in the action group number to run
  buf[5] = GET_LOW_BYTE(Times); // Obtain the low 8 bits of the execution count
  buf[6] = GET_HIGH_BYTE(Times); // Obtain the high 8 bits of the execution count
  isRunning_ = true;
...
### 7.8.1 Introduction to Library Files and Registers
...
#### 7.8.1.1 Library File Description
...
When implementing the color recognition and vision-based line following functions, the internal implementation of the functions is highly consistent with that of face recognition. Details are not repeated here. Review the source code and combine it with [7.8.1.2 Device Primary-Secondary Communication Principles (I2C Registers)](#p7-8-1-2) below to understand the physical meaning of the information stored at each address in the functional registers of the large AI model module.

<p id="p7-8-1-2"></p>

#### 7.8.1.2 Device Primary-Secondary Communication Principles (I2C Registers)
...
| Register | Data Format             | Description                                                  |
| :------- | :---------------------- | :----------------------------------------------------------- |
| 0x00     | `unsigned char data[4]` | `data[0]`: red center X-axis coordinate<br>`data[1]`: red center Y-axis coordinate<br>`data[2]`: red detection box width<br>`data[3]`: red detection box length |
| 0x01     | `unsigned char data[4]` | `data[0]`: green center X-axis coordinate<br>`data[1]`: green center Y-axis coordinate<br>`data[2]`: green detection box width<br>`data[3]`: green detection box length |
| 0x02     | `unsigned char data[4]` | `data[0]`: blue center X-axis coordinate<br>`data[1]`: blue center Y-axis coordinate<br>`data[2]`: blue detection box width<br>`data[3]`: blue detection box length |
| 0x03     | `unsigned char data[4]` | `data[0]`: purple center X-axis coordinate<br>`data[1]`: purple center Y-axis coordinate<br>`data[2]`: purple detection box width<br>`data[3]`: purple detection box length |
...
### 7.8.2 Development Board Management

> [!NOTE]
>
> * **Before starting the lessons in this chapter, it is essential to ensure that the ESP32 version in the development board manager is 3.0.7 or higher. Version 3.0.7 is recommended.**
>
> <img src="..\_static\media\chapter_6_8\section_1\media\image6.png"     class="common_img"/>

If the version is incorrect, follow the steps below to update or download it.

1. Click the **Development Board Manager** in the upper-left corner, and then search for ESP32.

   <img src="..\_static\media\chapter_6_8\section_1\media\image9.png"     class="common_img"/>

2. Select the corresponding version 3.0.7, and click **Download**.
...
1. Connect the Type-C port on the left side of the Tonybot large AI model module to the computer using a Type-C data cable.

<img src="..\_static\media\chapter_6_8\section_1\media\image40.png" class="common_img" style="width:550px"/>

2. Open the program file [7.8 Large AI Model Offline Course\02 Source Code\7.8.2 Image Transmission\02 Image Transmission Program\image\image.ino](https://drive.google.com/drive/folders/1NGsnx4M3Qm4rdLfXA3pQC0HvA0EpieQx?usp=sharing) under the same directory of this document.

<img src="..\_static\media\chapter_6_8\section_1\media\image4.png"     class="common_img"/>

3. Select **ESP32S3 Dev Module** as the development board model, and choose the corresponding port.

<img src="..\_static\media\chapter_6_8\section_1\media\image5.png"     class="common_img"/>

4. Click **Tools** in the menu bar, and configure the ESP32S3 development board settings according to the figure below. Note that this configuration is only required for the first use and is unnecessary for subsequent uses.

<img src="..\_static\media\chapter_6_8\section_1\media\image11.png"     class="common_img"/>

5. Click <img src="..\_static\media\chapter_6_8\section_1\media\image17.png"     class="common_img" style="width:45px"/> to download the program into the Tonybot large AI model module, and wait for the upload to complete.

<img src="..\_static\media\chapter_6_8\section_1\media\image18.png"     class="common_img" style="width:1000px"/>

6. Wait for a moment, and the message window below will display the upload success prompt.
...
<img src="..\_static\media\chapter_6_8\section_1\media\image37.png"     class="common_img" style="width:600px"/>

2. Open the program file [7.8 Large AI Model Offline Course\02 Source Code\7.8.3 Color Recognition\02 Color Recognition Program\02 Tonybot Color Recognition Program\demo\demo.ino](https://drive.google.com/drive/folders/1NGsnx4M3Qm4rdLfXA3pQC0HvA0EpieQx?usp=sharing) under the same directory as this document.

<img src="..\_static\media\chapter_6_8\section_1\media\image29.png"     class="common_img"/>

3. Select **ESP32 Dev Module** as the development board model, and choose the corresponding port.

<img src="..\_static\media\chapter_6_8\section_1\media\image30.png"     class="common_img"/>

4. Click **Tools** in the menu bar, and configure the ESP32 development board settings according to the figure below. Note that this configuration is only required for the first use and is unnecessary for subsequent uses.

<img src="..\_static\media\chapter_6_8\section_1\media\image31.png"     class="common_img"/>

5. Click <img src="..\_static\media\chapter_6_8\section_1\media\image17.png"     class="common_img" style="width:45px"/> to download the program into the Tonybot ESP32 controller, and wait for the upload to complete.
...
### 7.8.4 Image Transmission

#### 7.8.4.1 Project Introduction

**This section introduces how to view the camera real-time streaming screen by connecting to the Wi-Fi hotspot generated by the Tonybot large AI model module and logging into a fixed website.**

<img src="..\_static\media\chapter_6_8\section_1\media\image1_en.png" style="width:1000px" class="common_img"/>

#### 7.8.4.2 Program Download

Refer to [7.8.3 Program Download](#p7-8-3) to learn about downloading the program.

#### 7.8.4.3 Image Transmission Implementation

1. Once the program download is complete, search for and connect to the Wi-Fi hotspot named HW_ESP32S3CAM generated by the WonderLLM module.

<img src="..\_static\media\chapter_6_8\section_1\media\image20.png"     class="common_img" style="width:500px"/>

2. Enter **192.168.5.1** in the address bar of any mobile or PC browser. Press **Enter**, and then click the <img src="..\_static\media\chapter_6_8\section_1\media\image21.png"     class="common_img" style="width:120px"/> button on the page to access the camera streaming interface. This description uses a PC browser as an example.

<img src="..\_static\media\chapter_6_8\section_1\media\image23.png"     class="common_img" style="width:600px"/>

#### 7.8.4.4 Program Analysis

* **Large AI Model Module**

1. The **image.ino** file imports the header files related to Wi-Fi, camera, and LCD. The network services and local display used for image transmission are accessed from here.
...
2. The program predefines the hotspot name, password, and fixed IP. After connecting to the hotspot of the module, the video page can be opened directly through `192.168.5.1`.
...
3. The `startCameraServer()` function is implemented in **app_httpd.cpp** and is declared here first. The `xQueueAIFrame` queue is used to transfer image frames between the camera acquisition task and the display task.
...
4. The `setup` function creates the image queue at the beginning, and registers the camera and LCD display modules. This enables the image to be displayed on the screen and forwarded for web transmission.
...
5. Afterward, the program switches the ESP32-S3 to AP mode, configures the fixed IP, and starts the hotspot. Connecting a phone or computer to this hotspot enables access to the video stream page.
...
6. After successfully starting the hotspot, the `setup` function calls the `startCameraServer()` function to start the web video streaming service and prints the access address to the serial port.
...
7. The `loop` function does not handle specific operations because the image acquisition, display, and web transmission already run continuously in background tasks. Therefore, only an idle delay is kept here.
...
8. The function actually responsible for acquiring images in **camera_setting.c** is `task_process_handler()`. It continuously reads frame data from the driver layer and sends valid frames into the output queue.
...
9. The first 12 frames are actively discarded to avoid the initial stage when exposure and white balance are unstable, reducing screen jitter and color deviation after startup.
...
10. The `register_camera` function configures the `camera_config_t` structure, setting up the data pins, clock pins, frame format, buffer location, and other parameters all at once.
...
11. After the configuration is complete, the program initializes the camera through `esp_camera_init`, fine-tunes the mirror, flip, and saturation settings based on different sensor models, and finally creates the acquisition task.
...
### 7.8.5 Color Recognition

#### 7.8.5.1 Project Introduction

This section demonstrates color recognition by connecting the Tonybot large AI model module and controlling the glowy ultrasonic sensor on the robot head to synchronize its color with the recognized color.

<img src="..\_static\media\chapter_6_8\section_1\media\image24_en.png" style="width:1000px" class="common_img"/>

#### 7.8.5.2 Program Download

Refer to [7.8.3 Program Download](#p7-8-3) to learn about downloading the program.

#### 7.8.5.3 Program Outcome

Placing any of the three colors of red, green, or blue in front of the lens of the Tonybot large AI model module will cause the glowy ultrasonic sensor on the head of Tonybot to change to the corresponding color.

#### 7.8.5.4 Program Analysis

* **Large AI Model Module**

1. The **color_detection.ino** file first imports the camera, color recognition, LCD, and I2C sending modules. The color recognition process is linked through these four components.
...
2. A total of three queues are created in the main program, which are the raw image input queue, the LCD display queue, and the I2C result queue. Images and recognition results are passed between different tasks through these queues.
...
3. In the `setup` function, queues are created first, followed by the sequential registration of the camera, color recognition, LCD display, and I2C sending modules. This connects image acquisition, recognition, display, and transmission.
...
4. The input, output, and result queue handles are defined in **color_detection.cpp**, along with the global array `color_data[4]`. The recognition results of each color are written here later.
...
5. The thresholds for color recognition are defined centrally in `std_color_info`. Four colors of red, green, blue, and purple are registered by default, and subsequent recognition matches against these thresholds.
...
6. The `get_color_detection_result` function selects the color block with the largest area from multiple detected blocks of the same color, and writes the center point, width, and height to `color_data`.
...
7. The `task_process_handler()` function is the main task for color recognition. It registers thresholds with `ColorDetector` first, then continuously retrieves frames from the image queue, executes detection, draws results back onto the image, and writes them into the result queue.
...
8. If a certain color is not recognized in the current frame, the program clears the corresponding `id`, center point, and size to zero. This prevents the main controller from obtaining outdated data from the previous frame.
...
9. After the recognition task ends, the program sends the image to the LCD display and places the `color_data` into `xQueueResult` for the I2C transmission module to send back to Tonybot.
...
10. The `register_color_detection` function is the external registration entry. It saves the input and output queues to global variables and then creates the color recognition task.
...
1. The **demo.ino** file imports the robot mainboard, servo controller, camera communication library, and sensor library, and instantiates the ultrasonic, camera, and action control objects.
...
2. The program also prepares a buffer of `read_color_val[4]` to receive the color ID data sent back by the large AI model module.
...
3. The `color_detection` function reads the 4-byte color result through `tonybot_camera.color_id_detection`. It then determines whether the currently recognized color is red, green, or blue based on the return value.

```cpp
if(tonybot_camera.color_id_detection(read_color_val, 4)) {
...
4. After recognizing different colors, the program directly changes the glowy ultrasonic sensor to the corresponding color. If no valid color is recognized, the light is turned off.
...
5. In the `setup` function, `Serial2`, the default pose of the robot, the debugging serial port, and the camera communication are initialized. Then the ultrasonic light is turned off before entering the recognition loop.
...
6. The main loop continuously calls `color_detection` to refresh the recognition results every 30ms.
...
### 7.8.6 Face Recognition

#### 7.8.6.1 Project Introduction

**This section demonstrates how to detect whether a face is in front of the lens by connecting the Tonybot large AI model module. When a face appears in front of the lens, the robot executes the waving action group.**

<img src="..\_static\media\chapter_6_8\section_1\media\image26_en.png" style="width:1000px" class="common_img"/>

#### 7.8.6.2 Program Download

Refer to [7.8.3 Program Download](#p7-8-3) to learn about downloading the program.

#### 7.8.6.3 Program Outcome

When a face appears in front of the lens of the Tonybot large AI model module, Tonybot executes the waving action group.

#### 7.8.6.4 Program Analysis

* **Large AI Model Module**

1. The **face_detection.ino** file imports the camera, face detection, LCD, and I2C sending modules. The entire face recognition process is connected through these parts.
...
2. The program also defines three queues to store the raw images, processed images, and face result data respectively.
...
3. The `setup` function creates the queues and registers the camera, face detection, LCD, and I2C sending modules in sequence, forming a complete pipeline for image acquisition, detection, and transmission.
...
4. The two-stage face model is imported in **face_detection.cpp**, and `detect_result` is defined to save the latest face center point and size information.
...
5. The `save_detection_result` function converts the bounding box output by the model into a center point, width, and length, and then writes them to `detect_result` for transmission to the main controller through the I2C bus later.
...
6. The `task_process_handler()` function is the main task for face recognition. It first calls `HumanFaceDetectMSR01` to perform the first-stage candidate region detection, and then calls `HumanFaceDetectMNP01` for the second-stage refinement.
...
7. If a face is detected in the current frame, the program draws a box on the image and updates the result. If no face is detected, the center point and sizes are cleared to zero.
...
8. After the recognition is completed, the program sends the image for display while placing `detect_result` into the result queue for the I2C module to transmit to Tonybot.
...
9. The `register_human_face_detection` function is responsible for saving the queue handles and creating the background face recognition task.
...
1. The **demo.ino** file first imports the robot mainboard, servo controller, camera communication library, and sensor library, and instantiates the control objects and data buffers required for face recognition.
...
2. The `face_detection` function reads the 4-byte face recognition result through `tonybot_camera.face_data_receive`. As long as the first byte is not 0, a face is considered present in the current frame.

```cpp
if(tonybot_camera.face_data_receive(read_face_val, 4)) {
...
3. Action group 9 is executed here, which is the waving action. The subsequent `delay` function of 5000 milliseconds is used to wait for the action to finish and to prevent repeated triggers during continuous recognition.
...
4. In the `setup` function, `Serial2`, the default pose of the robot, the debugging serial port, and the camera communication are initialized. Then the ultrasonic light is turned off before entering the recognition loop.
...
5. The main loop continuously calls `face_detection` to check whether a face is recognized in the current frame every 30ms.
...
### 7.8.7 QR Code Recognition

#### 7.8.7.1 Project Introduction

**This section introduces QR code recognition by connecting the Tonybot large AI model module to detect whether a specified QR code is in front of the lens. If the QR code is detected, the corresponding action group is executed.**

<img src="..\_static\media\chapter_6_8\section_1\media\image27_en.png" style="width:1000px" class="common_img"/>

#### 7.8.7.2 Program Download

Refer to [7.8.3 Program Download](#p7-8-3) to learn about downloading the program.

#### 7.8.7.3 Program Outcome

When a specified QR code appears in front of the lens of the Tonybot large AI model module, the robot executes the corresponding action group.
...
#### 7.8.7.4 Program Analysis

* **Large AI Model Module**

1. The main file on the module side for QR code recognition is **code_recognition.ino**. It first imports the camera, QR code recognition, I2C transmission, and global structure definitions.
...
2. The program also prepares three queues to transfer the raw images, display images, and QR code recognition results.
...
3. The `setup` function first creates these queues, and then registers the camera, QR code recognition, and I2C transmission modules in sequence, forming a complete offline recognition pipeline.
...
4. The structure `I2C_Data_t` for I2C transmission is defined in **global.h**, which stores both the string content and the string length.
...
5. The component actually responsible for scanning codes in **code_recognition.cpp** is `esp_code_scanner`. Every time the program receives an image frame, it creates a code scanner, configures the image format, and starts recognition.
...
6. If the recognition is successful, the program copies the QR code content into `i2c_data.data` and records `datalen`. If not recognized, it sends back `"null"` by default.
...
7. After the processing of the current frame is completed, the program destroys the code scanner, manages the image buffer, and sends the QR code recognition results into `xQueueResult` to wait for transmission to the main controller through the I2C module.
...
8. The `register_code_recognition` function binds the queues and starts the QR code recognition task.
...
1. The **demo.ino** file first imports the robot mainboard, servo controller, camera communication library, and sensor library, and instantiates the control objects and data buffers required for QR code recognition.
...
2. The `code_detection` function reads the QR code string data through `tonybot_camera.code_data_detection`, and then copies the actual string content starting from `read_code_val[1]`.

```cpp
if(tonybot_camera.code_data_detection(read_code_val, sizeof(read_code_val))) {
    char code_val[read_code_val[0]];
    memcpy(code_val, &read_code_val[1], read_code_val[0]);
}
```

3. The program then checks if the QR code content contains `dance` or `gymnastics` using `strstr`, and executes action group 17 or action group 103 respectively.
...
5. The main loop continuously calls `code_detection` to check whether a new QR code is recognized in the current frame every 30ms.
