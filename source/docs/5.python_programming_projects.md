...
(2) Select [Appendix\Program Collection\\ Python Project Programs]() and click the '**Select Folder**' button.
...
(3) After making the changes, refer to the [Program Download]() section to run the updated program.

### 5.2.2 Distance Ranging & Display
...
(3) Once you’ve made the changes, refer to section “4. Program Download” to run the updated program.
...
(3) After making the modifications, refer to section "[Program Download]()" to run the updated program.
...
**Hiwonder** library: Provides functions for robot control and low-voltage alarms.

**time** library: Used for time-related functions.

**Hiwonder_IIC** library: Controls sensors via I2C communication.
...
Create the I2C communication object.

Initialize the Tonybot robot object.

Set up the ultrasonic sensor object, using I2C communication.

Create the ledmatrix object for the dot matrix display, connected to GPIO pins 2 and 5.
...
<img class="common_img" src="../_static/media/chapter_5/section_2/04/media/image13.png"  />

(4) Main Loop:

Continuously read the distance from the ultrasonic sensor and convert it to centimeters.

If the distance exceeds 1000 mm, set it to 1000 mm.

Calculate the color_diff based on the distance. If the distance is greater than 250 mm, set color_diff to 250.

Adjust the RGB color of the ultrasonic sensor using color_diff.

Display the distance on the dot matrix module.

Pause for 200 milliseconds before the loop repeats.
...
When step is 0, the robot will perform actions based on the measured distance.

If the distance is greater than 30 mm and less than or equal to 350 mm, the breathing light will turn white, and step will remain 0.

For other distance values, the breathing light will turn green, and step will be updated to 1.
...
<img class="common_img" src="../_static/media/chapter_5/section_2/05/media/image15.png"  />
...
(3) After making the changes, refer to section "4. Program Download" to run the updated program.
...
(3) After making the necessary changes, follow the steps in the "5. Program Download" section to run the program.
...
[Temperature and Humidity Detection Program]()
...
(3) Finally, follow the steps in "[Program Download]()" to upload the modified code to the Tonybot.
...
[Image Transmission Python Example]()

(1) ESP32-S3 Vision Module Firmware Download 

① Connect the ESP32-S3 vision module to your computer using a Type-C data cable.

② Extract the ZIP file “5.4.2 Image Transmission\02 Image Transmission Firmware & Flash Tool\flash_download_tool_3.9.7” located in the same folder, then double-click “flash_download_tool_3.9.7.exe” to open the program.
...
[Color Recognition Python Program]()
...
[Face Recognition Python Example]()
...
[Vision Line Following Python Example]()

① Open the “**03 Vision Line Following Python Example\facial_recognition.py**” file from the same directory in your Python editor.
...
For instructions on downloading the vision module and Tonybot program, please refer to the "[Program Download]()" section.
