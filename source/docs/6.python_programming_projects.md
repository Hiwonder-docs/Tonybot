...
> [!NOTE]
>
> **The large AI model module is flashed with the online mode firmware by default. If the offline mode program has been flashed before studying this chapter, please refer to [4. Large AI Model Basic Course -> 4.10 Firmware Download](https://docs.hiwonder.com/projects/Tonybot/en/latest/docs/4.%20Large%20AI%20Model%20Basic%20Course.html#firmware-download) to download the firmware again.**
...
To learn more about offline mode applications, please refer to [6.8. Large AI Model Offline Course](https://docs.hiwonder.com/projects/Tonybot/en/latest/docs/6.python_programming_projects.html#large-ai-model-offline-course).

#### 6.7.1.2 Online Mode

The online mode supports large AI model voice interaction and uses the command wake-up mode. Speak the wake-up word to wake up the large AI model module. Once activated, human-robot interaction can begin. The default wake-up phrase is **Hello Hiwonder**. To change the wake-up word, please refer to [4. Large AI Model Basic Course -> 4.9 Wake-up Word Modification](https://docs.hiwonder.com/projects/Tonybot/en/latest/docs/4.%20Large%20AI%20Model%20Basic%20Course.html#wake-up-word-modification).
...
3. Drag [02 Source Code\02 Smart Traffic Driving Program\main.py](https://drive.google.com/drive/folders/1PzKt-ltIEj1q6Z-_xh1BNX-wfpJdJI6-?usp=sharing) under the same directory into the Hiwonder Python Editor. Note that this is only effective when dragged into the red box area.
...
2. Open the program file [6.8 Large AI Model Offline Course\02 Source Code\6.8.2 Image Transmission\02 Image Transmission Program\image\image.ino](https://drive.google.com/drive/folders/153FdpJ_YyCnnMvGpsrxgRQZjyKbmJTSA?usp=sharing) under the same directory as this document.
...
2. Open the program file [6.8 Large AI Model Offline Course\02 Source Code\6.8.2 Image Transmission\02 Image Transmission Program\image\image.ino](https://drive.google.com/drive/folders/1KvuMxuIjB9Il26fDVJTesQ9ia8a0AJFz?usp=sharing) under the same directory of this document.
